...
# define YYTOKENTYPE
  enum yytokentype
  {
    ...
    COMENTARIO = 258,              /* COMENTARIO  */
    ASIGNACION = 259,              /* ASIGNACION  */
    IGUAL = 260,                   /* IGUAL  */
    VARIABLES = 261,               /* VARIABLES  */
    RECUADROS = 262,               /* RECUADROS  */
    COLOR = 263,                   /* COLOR  */
    LINEAS = 264,                  /* LINEAS  */
    ...
    MENOS = 270,                   /* MENOS  */
    ENTERO = 271,                  /* ENTERO  */
    IDENTIFICADORMINUSCULA = 272,  /* IDENTIFICADORMINUSCULA  */
    IDENTIFICADORMAYUSCULA = 273,  /* IDENTIFICADORMAYUSCULA  */
    REAL = 274,                    /* REAL  */
    BOOL = 275,                    /* BOOL  */
    menos = 276                    /* menos  */
  };
